...
var require_url_state_machine = __commonJS((exports, module) => {
  ...
  function parseIPv4Number(input) {
    ...
    const regex4 = R === 10 ? /[^0-9]/ : R === 16 ? /[^0-9A-Fa-f]/ : /[^0-7]/;
...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => Promise.resolve().then(() => __toESM(require_lib2(), 1)).then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var resolveResponse = () => __awaiter2(undefined, undefined, undefined, function* () {
  if (typeof Response === "undefined") {
    return (yield Promise.resolve().then(() => __toESM(require_lib2(), 1))).Response;
  }
  return Response;
});
...
var fetchWithAuth = (supabaseKey, getAccessToken, customFetch) => {
  ...
  return (input, init2) => __awaiter6(undefined, undefined, undefined, function* () {
    var _a;
    const accessToken = (_a = yield getAccessToken()) !== null && _a !== undefined ? _a : supabaseKey;
    let headers = new HeadersConstructor(init2 === null || init2 === undefined ? undefined : init2.headers);
...
class GoTrueClient {
  constructor(options) {
    ...
    } else if (isBrowser2() && ((_a = globalThis === null || globalThis === undefined ? undefined : globalThis.navigator) === null || _a === undefined ? undefined : _a.locks)) {
  ...
  async linkIdentity(credentials) {
    ...
    try {
      ...
      if (error)
        throw error;
      if (isBrowser2() && !((_a = credentials.options) === null || _a === undefined ? undefined : _a.skipBrowserRedirect)) {
  ...
  _removeVisibilityChangedCallback() {
    ...
    this.visibilityChangedCallback = null;
    try {
      if (callback && isBrowser2() && (window === null || window === undefined ? undefined : window.removeEventListener)) {
  ...
  async _handleVisibilityChange() {
    ...
    if (!isBrowser2() || !(window === null || window === undefined ? undefined : window.addEventListener)) {
...
// core/supabase.ts
var PUBLIC_URL = "https://rrubwukbozlveswbvvyv.supabase.co";
var PUBLIC_KEY = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJydWJ3dWtib3psdmVzd2J2dnl2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mzc4OTkzNjEsImV4cCI6MjA1MzQ3NTM2MX0.arZ6M3n3vF5e9Hapy-gZ3xw15IGwDwV4IkWYxxonrzY`;
var supabase_default = createClient(PUBLIC_URL, PUBLIC_KEY, {
  db: {
    schema: "public"
  },
  auth: {
      ...
      return main.newListr([
        {
          ...
          task: async (ctx) => {
            try {
              const { data } = await supabase_default.auth.signInAnonymously();
              if (data) {
                ctx.host = data.user;
...
var configPath = join(homedir(), ".mati", ".mati.json");
var config = Bun.file(configPath, { type: "application/json" });
try {
  if (await config.exists()) {
    ...
    config.write(JSON.stringify(await init2.run({
